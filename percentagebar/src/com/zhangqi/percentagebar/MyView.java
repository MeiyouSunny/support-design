...
public class MyView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		for (int i = 1; i <= 12; i++) {
			...
			canvas.drawLine(width / 2, height / 2 - 300, width / 2,
					height / 2 - 270, mPaintLine);
		...
		canvas.drawLine(width / 2, height / 2 - 200, width / 2,
				height / 2 + 40, mPaintLine);
		canvas.restore();
		// 绘制时针
		...
		canvas.drawLine(width / 2, height / 2 - 170, width / 2,
				height / 2 + 30, mPaintLine);
		canvas.restore();
		// 绘制秒针
		...
		canvas.drawLine(width / 2, height / 2 - 220, width / 2,
				height / 2 + 50, mPaintSecondLine);
		canvas.restore();
	}
}
